...
Using the results from Table \ref{psocalibrationsummary}, a trendline is plotted in Microsoft Excel. A logarithmic trendline suits the data better than a quartic trendline. 
